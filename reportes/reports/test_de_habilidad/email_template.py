"""
Email template constants for the test_de_habilidad report type.
...
Has completado tu Test de Habilidad correctamente. En el informe adjunto encontrarás tu plan de estudio personalizado con las lecciones a realizar
