...
class AssessmentDownloader:
    ...
    def get_latest_timestamp_from_json(self, json_file_path: str) -> Optional[int]:
        """Get the latest 'submittedTimestamp' from an existing JSON file"""
    ...
    def download_assessment_responses_incremental(self, assessment_id: str, assessment_name: str, return_df: bool = False) -> Union[List[Dict[str, Any]], pd.DataFrame]:
        """
    ...
    def get_only_new_responses(self, assessment_id: str, assessment_name: str, return_df: bool = False) -> Union[List[Dict[str, Any]], pd.DataFrame]:
        """
    ...
    def save_responses_to_csv(self, responses: Union[List[Dict[str, Any]], pd.DataFrame], assessment_name: str, return_df: bool = False, include_usernames: bool = True) -> Union[str, pd.DataFrame]:
        """
        ...
        if return_df:
            ...
            responses_list = df.to_dict('records')
            ...
            for r in responses_list:
                ...
                for ans in answers:
                    ...
                    if desc:
                        ...
                        if answer_val is None or answer_val == "" or (isinstance(answer_val, float) and pd.isna(answer_val)):
    ...
    def filter_responses(self, responses: Union[List[Dict[str, Any]], pd.DataFrame]) -> Union[List[Dict[str, Any]], pd.DataFrame]:
        """
    ...
    def add_answer_columns_to_csv(self, csv_path: str, responses: Union[List[Dict[str, Any]], pd.DataFrame]) -> None:
        """
    ...
    def _download_and_process_common(
        ...
        if save_csv_func and not download_only:
            ...
            if incremental_mode:
                ...
                # Use temporary CSV function (eg base: write temp CSV for incremental path)
