...
class AssessmentMapper:
    def __init__(self):
        ...
        self.assessment_ids = {
            ...
            os.getenv("CL_ASSESSMENT_ID"): "CL",
            os.getenv("CIEN_ASSESSMENT_ID"): "CIEN",
    ...
    def get_assessment_type(self, assessment_id: str) -> Optional[str]:
        ...
        Returns:
            Assessment type (M1, CL, CIEN, HYST) or None if not found
        """
    ...
    def get_assessment_id(self, assessment_type: str) -> Optional[str]:
        ...
        Args:
            assessment_type: Assessment type (M1, CL, CL, CIEN, HYST)
