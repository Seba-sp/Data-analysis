...
class DiagnosticosApp:
    ...
    def _get_assessment_list(self) -> List[Dict[str, str]]:
        ...
        assessment_ids = {
            ...
            'F30M': os.getenv("F30M_ASSESSMENT_ID"),
            'B30M': os.getenv("B30M_ASSESSMENT_ID"),
            'Q30M': os.getenv("Q30M_ASSESSMENT_ID"),
    ...
    def analyze_assessment(self, assessment_type: str, incremental_mode: bool = False, 
        ...
        Args:
            assessment_type: Type of assessment (M1, F30M, B30M, Q30M, HYST)
        ...
        try:
            ...
            if self.storage.exists("reports"):
                pdf_files = [
                    ...
                    if filename.endswith('.pdf') and filename.startswith('informe_uim_')
                ]
        ...
        try:
            ...
            for _, row in analysis_df.iterrows():
                try:
                    ...
                    filename = f"informe_uim_{username}_{assessment_type}.pdf"
    ...
    def _extract_email_from_filename(self, filename: str) -> str:
        ...
        Filename format: informe_uim_email_assessment.pdf
...
def main():
    ...
    parser.add_argument("--assessment", choices=["M1", "F30M", "B30M", "Q30M", "HYST"], help="Process specific assessment type")
